...
- **Half-Time Goals**:
  - **HTHG** (Half-Time Home Team Goals) : Strongly affects the likelihood of "Home Win" (1.397862).
  - **HTAG** (Half-Time Away Team Goals) : Increases the likelihood of "Away Win" (0.8065173).

- **Shots on Target**:
  - **HST** (Home Shots on Target) is significant for predicting **Home Wins**, with more shots on target decrease the likelihood of an **Away Win**.
...
- **Red Cards**:
  - **HR** (Home Red Cards) has a significant positive effect on **Away Wins**. More home red cards increase the likelihood of a **Away Win**.
