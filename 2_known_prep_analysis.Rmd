...
pred_multinom_model <- predict(multinom_model, test_data, type = "prob")
pred_multinom_model.inter <- predict(multinom_model.inter, test_data, type = "prob")
pred_multinom_model.clean <- predict(multinom_model.clean, test_data, type = "prob")
pred_multinom_model.clean.inter <- predict(multinom_model.clean.inter, test_data, type = "prob")
```
...
true_labels <- test_data$FTR

# Compute ROC and AUC for each model
roc_multinom_model <- multiclass.roc(true_labels, pred_multinom_model[,2])
roc_multinom_model.inter <- multiclass.roc(true_labels, pred_multinom_model.inter)
roc_multinom_model.clean <- multiclass.roc(true_labels, pred_multinom_model.clean)
roc_multinom_model.clean.inter <- multiclass.roc(true_labels, pred_multinom_model.clean.inter)
```
...
# Plot ROC curve for the multinom_model
plot(roc_multinom_model, col = "blue", lwd = 2, main = "ROC - Multinom Model", print.auc = TRUE)
```