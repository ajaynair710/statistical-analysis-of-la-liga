...
1. **Stepwise Model**: This model shows the highest performance, particularly due to its good balance in sensitivity and specificity, making it a strong choice overall.

2. **Ridge Model**: This Model also demonstrates solid performance across all three metrics, especially excelling in specificity.

3. **Full Interaction Model**: This model is another strong contender, showing high performance across accuracy and sensitivity, making it a good choice as well.

So, choosing **Stepwise model** for predicting the final results for the matches of the 2023/2024 season. 
...
saveRDS(stepwise_model, "./model/model_file.rds")
```
